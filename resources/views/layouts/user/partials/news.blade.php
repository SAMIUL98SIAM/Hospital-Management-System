              ...
              <div class="card-blog">
                ...
                <div class="body">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="{{asset('user/assets/img/person/person_4.jpg')}}" alt="">
                      </div>
              ...
              <div class="card-blog">
                ...
                <div class="body">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="{{asset('user/assets/img/person/person_3.jpg')}}" alt="">
                      </div>
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  ...
                  <a href="blog-details" class="post-thumb">
                    <img src="{{asset('user/assets/img/blog/blog_4.jpg')}}" alt="">
                  </a>
                </div>
                <div class="body">
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  ...
                  <a href="blog-details" class="post-thumb">
                    <img src="{{asset('user/assets/img/blog/blog_5.jpg')}}" alt="">
                  </a>
                </div>
                <div class="body">
